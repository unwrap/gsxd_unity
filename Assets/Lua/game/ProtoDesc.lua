assert(protoc:load([[
syntax = "proto3";
package GameCommon.NetMsg;

message MsgRequestRegister // IRequest
{
    int32 RpcId = 90;
    int32 Error = 91;
    string Message = 92;
...
message MsgResponseRegister // IResponse
{
    int32 RpcId = 90;
    int32 Error = 91;
    string Message = 92;
    ...
    string Account = 1;
    sint64 AccountID = 2;           // 如果注册成功返回账号id
    string Password = 3;
    string RandomKey = 4;
}

message MsgLoginRequest // IRequest
{
    int32 RpcId = 90;
...
message MsgLoginResponse // IResponse
{
    int32 RpcId = 90;
    int32 Error = 91;  //10008,账号不存在
    string Message = 92;
