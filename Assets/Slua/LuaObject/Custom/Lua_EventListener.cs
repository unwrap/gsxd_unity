...
public class Lua_EventListener : LuaObject {
	...
	[UnityEngine.Scripting.Preserve]
	static public int PassPointerDownEvent(IntPtr l) {
		try {
			#if DEBUG
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int PassPointerUpEvent(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int PassPointerClickEvent(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public int Get_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject))){
				...
				var ret=EventListener.Get(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(SLua.LuaTable),typeof(bool))){
				UnityEngine.GameObject a1;
				checkType(l,1,out a1);
				SLua.LuaTable a2;
				checkType(l,2,out a2);
				...
				var ret=EventListener.Get(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			else if(matchType(l,argc,1,typeof(UnityEngine.Transform),typeof(SLua.LuaTable),typeof(bool))){
				UnityEngine.Transform a1;
				checkType(l,1,out a1);
				SLua.LuaTable a2;
				checkType(l,2,out a2);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_onEnter(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_onExit(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_onUpdateSelect(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			EventListener self=(EventListener)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.onUpdateSelect);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,PassPointerDownEvent);
		addMember(l,PassPointerUpEvent);
		addMember(l,PassPointerClickEvent);
		...
		addMember(l,"onEnter",get_onEnter,set_onEnter,true);
		addMember(l,"onExit",get_onExit,set_onExit,true);
		addMember(l,"onUp",get_onUp,set_onUp,true);
		addMember(l,"onSelect",get_onSelect,set_onSelect,true);
		addMember(l,"onUpdateSelect",get_onUpdateSelect,set_onUpdateSelect,true);
		addMember(l,"onSubmit",get_onSubmit,set_onSubmit,true);
		createTypeMetatable(l,null, typeof(EventListener),typeof(LuaMonoBehaviourBase));
	}
}
