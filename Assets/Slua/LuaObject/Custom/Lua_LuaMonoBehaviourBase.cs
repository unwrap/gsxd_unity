...
public class Lua_LuaMonoBehaviourBase : LuaObject {
	...
	static public int GetLuaTable(IntPtr l) {
		try {
			...
			#endif
			#endif
			LuaMonoBehaviourBase self=(LuaMonoBehaviourBase)checkSelf(l);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int CleanLuaTable(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public int DoFile(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				var ret=self.DoFile(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function DoFile to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int CallLuaFunction(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				self.CallLuaFunction(a1,a2,a3);
				pushValue(l,true);
				return 1;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function CallLuaFunction to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int CallLuaFunctionByParams(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			self.CallLuaFunctionByParams(a1,a2);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int FormatException_s(IntPtr l) {
		try {
			...
			var ret=LuaMonoBehaviourBase.FormatException(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
