...
public class Lua_AssetBundleLoadManifestOperation : LuaObject {
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"AssetBundleLoadManifestOperation");
		addMember(l,Update);
		createTypeMetatable(l,constructor, typeof(AssetBundleLoadManifestOperation),typeof(AssetBundleLoadAssetOperationFull));
	}
}
