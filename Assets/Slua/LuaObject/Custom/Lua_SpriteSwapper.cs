...
public class Lua_SpriteSwapper : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_enabledSprite(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			SpriteSwapper self=(SpriteSwapper)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.enabledSprite);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_enabledSprite(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"SpriteSwapper");
		addMember(l,Awake);
		addMember(l,SetEnable);
		addMember(l,SwapSprite);
		addMember(l,"enabledSprite",get_enabledSprite,set_enabledSprite,true);
		addMember(l,"disabledSprite",get_disabledSprite,set_disabledSprite,true);
		createTypeMetatable(l,null, typeof(SpriteSwapper),typeof(UnityEngine.MonoBehaviour));
	}
}
