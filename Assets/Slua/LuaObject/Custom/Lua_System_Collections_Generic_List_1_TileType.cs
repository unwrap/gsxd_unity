...
public class Lua_System_Collections_Generic_List_1_TileType : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			System.Collections.Generic.List<TileType> o;
			if(argc==1){
				o=new System.Collections.Generic.List<TileType>();
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
				...
				o=new System.Collections.Generic.List<TileType>(a1);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<TileType>))){
				System.Collections.Generic.IEnumerable<TileType> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<TileType>(a1);
				pushValue(l,true);
				pushValue(l,o);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				TileType a1;
				a1 = (TileType)LuaDLL.luaL_checkinteger(l, 2);
				System.Collections.Generic.IComparer<TileType> a2;
				...
				System.Collections.Generic.IComparer<TileType> a4;
	...
	static public int Insert(IntPtr l) {
		try {
			...
			checkType(l,2,out a1);
			TileType a2;
			a2 = (TileType)LuaDLL.luaL_checkinteger(l, 3);
			self.Insert(a1,a2);
			pushValue(l,true);
			return 1;
		}
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<TileType> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(IComparer<TileType>))){
				System.Collections.Generic.List<TileType> self=(System.Collections.Generic.List<TileType>)checkSelf(l);
				System.Collections.Generic.IComparer<TileType> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(System.Comparison<TileType>))){
				System.Collections.Generic.List<TileType> self=(System.Collections.Generic.List<TileType>)checkSelf(l);
				System.Comparison<TileType> a1;
				checkDelegate(l,2,out a1);
				self.Sort(a1);
				pushValue(l,true);
				return 1;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<TileType> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				pushValue(l,true);
				return 1;
	...
	static public int setItem(IntPtr l) {
		try {
			...
			checkType(l,2,out v);
			TileType c;
			c = (TileType)LuaDLL.luaL_checkinteger(l, 3);
			self[v]=c;
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<TileType>));
	}
}
