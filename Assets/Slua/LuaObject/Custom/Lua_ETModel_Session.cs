...
public class Lua_ETModel_Session : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_LastRecvTime(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"ETModel.Session");
		addMember(l,Dispose);
		addMember(l,Send);
		addMember(l,"LastRecvTime",get_LastRecvTime,null,true);
		addMember(l,"LastSendTime",get_LastSendTime,null,true);
		addMember(l,"Error",get_Error,set_Error,true);
		createTypeMetatable(l,constructor, typeof(ETModel.Session),typeof(ETModel.Entity));
	}
}
