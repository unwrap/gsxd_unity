...
public class Lua_DropEventListener : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_onPointerEnter(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			DropEventListener self=(DropEventListener)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.onPointerEnter);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onPointerEnter(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_onPointerExit(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			DropEventListener self=(DropEventListener)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.onPointerExit);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onPointerExit(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DropEventListener");
		addMember(l,OnDrop);
		addMember(l,OnPointerEnter);
		addMember(l,OnPointerExit);
		addMember(l,Get_s);
		addMember(l,"onPointerEnter",get_onPointerEnter,set_onPointerEnter,true);
		addMember(l,"onPointerExit",get_onPointerExit,set_onPointerExit,true);
		addMember(l,"onDrop",get_onDrop,set_onDrop,true);
		createTypeMetatable(l,null, typeof(DropEventListener),typeof(UnityEngine.MonoBehaviour));
	}
}
