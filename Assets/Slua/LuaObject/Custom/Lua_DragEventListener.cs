...
public class Lua_DragEventListener : LuaObject {
	...
	static public int Get_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject))){
				...
				var ret=DragEventListener.Get(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				var ret=DragEventListener.Get(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"DragEventListener");
		...
		createTypeMetatable(l,null, typeof(DragEventListener),typeof(UnityEngine.MonoBehaviour));
	}
}
