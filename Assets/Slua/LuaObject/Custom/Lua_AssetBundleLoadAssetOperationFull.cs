...
public class Lua_AssetBundleLoadAssetOperationFull : LuaObject {
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"AssetBundleLoadAssetOperationFull");
		addMember(l,GetAsset);
		addMember(l,GetGameObject);
		addMember(l,IsDone);
		addMember(l,Update);
		addMember(l,"progress",get_progress,null,true);
		createTypeMetatable(l,constructor, typeof(AssetBundleLoadAssetOperationFull),typeof(AssetBundleLoadAssetOperation));
	}
}
