...
public class Lua_LeanTween : LuaObject {
	...
	static public int alpha_s(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.RectTransform),typeof(float),typeof(float))){
				UnityEngine.RectTransform a1;
				checkType(l,1,out a1);
				System.Single a2;
				checkType(l,2,out a2);
	...
	static public int color_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Color),typeof(float))){
				UnityEngine.GameObject a1;
				checkType(l,1,out a1);
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.RectTransform),typeof(UnityEngine.Color),typeof(float))){
				UnityEngine.RectTransform a1;
				checkType(l,1,out a1);
				UnityEngine.Color a2;
				checkType(l,2,out a2);
	...
	static public int rotateAround_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(UnityEngine.Vector3),typeof(float),typeof(float))){
				UnityEngine.GameObject a1;
				checkType(l,1,out a1);
				UnityEngine.Vector3 a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.RectTransform),typeof(UnityEngine.Vector3),typeof(float),typeof(float))){
				UnityEngine.RectTransform a1;
				checkType(l,1,out a1);
				UnityEngine.Vector3 a2;
				checkType(l,2,out a2);
	...
	static public int easeInOutQuadOpt_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(float),typeof(float),typeof(float))){
				System.Single a1;
				checkType(l,1,out a1);
				System.Single a2;
				checkType(l,2,out a2);
