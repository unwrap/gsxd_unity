...
public class Lua_AnimatedButton : LuaObject {
	...
	static public int set_onClick(IntPtr l) {
		try {
			...
			#endif
			AnimatedButton self=(AnimatedButton)checkSelf(l);
			AnimatedButton.ButtonClickedEvent v;
			checkType(l,2,out v);
			self.onClick=v;
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,null, typeof(AnimatedButton),typeof(UnityEngine.EventSystems.UIBehaviour));
	}
}
